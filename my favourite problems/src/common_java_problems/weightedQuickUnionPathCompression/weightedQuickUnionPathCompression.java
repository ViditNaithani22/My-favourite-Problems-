package common_java_problems.weightedQuickUnionPathCompression;

import common_java_problems.weightedQuickUnion.weightedQuickUnion;
...
public class weightedQuickUnionPathCompression {
    ...
    public static void main(String[] args) {
        ...
        weightedQuickUnionPathCompression qf = new weightedQuickUnionPathCompression(10);
        qf.union(4,3);
        qf.union(3,8);
        qf.union(9,4);
